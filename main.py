...
def play_game(nn=None, human_controlled=True, clock_speed=10, snake_color=(0, 120, 0), score=0):
    crashed = False
...
if __name__ == "__main__":
    ...
    while True:
        ...
        for genome in population:
            ...
            genome_score, fitness = play_game(genome.nn, False, 50000)
        ...
        show_best = True
        if show_best:
            play_game(best_genome_pop.nn, False, 20, (50, 50, 230))
