...
def display_snake(snake_position, display):
    for position in snake_position:
        pygame.draw.rect(display, (0, 220, 0), pygame.Rect(position[0], position[1], 10, 10))

def display_apple(apple_position, display):
    pygame.draw.rect(display, (220, 100, 0), pygame.Rect(apple_position[0], apple_position[1], 10, 10))
...
final_score = play_game(snake_head, snake_position, apple_position, 1, 0, display, clock)
